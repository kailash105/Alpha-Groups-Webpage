  ...
  <footer className="bg-gray-900 text-gray-100 pt-12 pb-4">
    <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><Link to="/services#interior" className="hover:underline">Interior Design</Link></li>
          <li><Link to="/services#construction" className="hover:underline">Construction</Link></li>
